---
sidebar: sidebar
permalink: citrix_iscsi_device_configuration.html
keywords: appendix, configuration, multipath, iscsi
summary: TR-4854
---

= iSCSI Device Configuration: NetApp HCI for Citrix Virtual Apps
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
To configure iSCSI devices, edit the multipath configuration file at `/etc/multipath.conf` as follows:
...
link:citrix_where_to_find_additional_information.html[Next: Where to Find Additional Information]
